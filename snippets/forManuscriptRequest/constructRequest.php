<?php
	...
	The policy of this publisher only allows the accepted version (not the publisher’s final version) to be placed in the repository. This is defined as the author’s manuscript with any changes made as a result of the peer-review process, but prior to publisher’s copy-editing or formatting. 
	
	Please attach a copy of the appropriate file in a reply to this email.
