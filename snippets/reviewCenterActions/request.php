<?php
	...
	if(!isset($_POST['emailStep']))
	{
		...
		$recipients['emails'] = array_filter($recipients['emails']);
		...
		{
			echo '<div class="col-sm-12 alert-danger border border-dark rounded"><b> -- Important notes : <br></b>* '.implode('<br> * ', $recipients['notes']).' </div>';
		}		
