<?php
	if(isset($_POST['note']))
	{
		...
		$parentRowID = mapTransformSave('irts', $idInIRTS, '', $field, '', 1, 'problem', NULL);

		$field = 'note';

		$rowID = mapTransformSave('irts', $idInIRTS, '', $field, '', 1, $note, $parentRowID);

		$field = 'processedBy';

		$rowID = mapTransformSave('irts', $idInIRTS, '', $field, '', 1, $reviewer, NULL);
