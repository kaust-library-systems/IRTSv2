<?php
	if(!isset($_POST['reasons'])&&!isset($_POST['other']))
	{
		...
		{
			$reasonArray = array(
				"The link refers to a supplemental file.",
				"The linked version is a final publisher formatted PDF and can not be deposited under the journal policy.",
				"The link refers to the publisher landing page and no file is available that can be deposited under the journal policy.",
				"The link is referring to a related item of a different type.");
		}
		elseif($_GET['itemType'] == 'Dataset')
		{
			$reasonArray = array("None of the dataset creators are KAUST affiliated authors on the related article.","The dataset was cited by or references the article, but was not created as part of the research for the article");
		}
		else
		{
			$reasonArray = array(
				"Only the current or present address of an author is KAUST", 
				"KAUST is mentioned in the text of the item", 
				"There is only a minor, non-funding acknowledgment of KAUST", 
				"Thuwal is mentioned in the text of the item", 
				"Only an editor or reviewer of the item is KAUST-affiliated", 
				"KAUST is mentioned in the references", 
				"KAUST is mentioned in an advertisement accompanying the item", 
				"KAUST is mentioned in the biography of an author, but their affiliation with KAUST is not current", 
				"Record is for book with some book chapters by KAUST-affiliated authors, the chapters have their own DOIs and will be handled separately", 
				"File stamped with indication that download was by or access was provided by KAUST", 
				"An author is affiliated to SABIC at KAUST, but not to KAUST directly", 
				"An author is affiliated to Aramco at KAUST, but not to KAUST directly", 
				"Totally erroneous search result, can not find any mention of KAUST or Thuwal");
		}
