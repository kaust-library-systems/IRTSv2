	...
	if(isset($_GET['task']))
	{
		...
		foreach($processes as $process)
		{
			...
			if(function_exists($process))
			{
				...
				$processRunTime = microtime(true)-$processRunTime;
			
				insert($irts, 'messages', array('process', 'type', 'message'), array('processRunTime', 'report', $process.' run time: '.$processRunTime.' seconds'));
			}
